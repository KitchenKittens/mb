...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const messages = [
    { title:"出会った日", meta:"場所・日付 A", text:"あなたと初めて会った日のこと。", img:`${basePath}/photo1.jpg` },
    { title:"初めての旅行", meta:"場所・日付 B", text:"一緒に行った旅行の思い出。", img:`${basePath}/photo2.jpg` },
    { title:"雨の日の傘", meta:"場所・日付 C", text:"雨の中のささやかな優しさ。", img:`${basePath}/photo3.jpg` },
    { title:"笑い合った夜", meta:"場所・日付 D", text:"おかしくて仕方なかった夜の思い出。", img:`${basePath}/photo4.jpg` },
    { title:"君の料理", meta:"場所・日付 E", text:"忘れられない手料理。", img:`${basePath}/photo5.jpg` },
    { title:"映画デート", meta:"場所・日付 F", text:"感想を語り合った映画デート。", img:`${basePath}/photo6.jpg` },
    { title:"小さなサプライズ", meta:"場所・日付 G", text:"ちょっとした驚きを喜んでくれた。", img:`${basePath}/photo7.jpg` },
    { title:"散歩の時間", meta:"場所・日付 H", text:"夕方の散歩のぬくもり。", img:`${basePath}/photo8.jpg` },
    { title:"記念日", meta:"場所・日付 I", text:"特別な日の振り返り。", img:`${basePath}/photo9.jpg` },
    { title:"雨上がりの景色", meta:"場所・日付 J", text:"澄んだ空を見た日。", img:`${basePath}/photo10.jpg` },
    { title:"誕生日の準備", meta:"場所・日付 K", text:"君のために準備した時間。", img:`${basePath}/photo11.jpg` },
    { title:"一緒に作った", meta:"場所・日付 L", text:"共同作業の楽しさ。", img:`${basePath}/photo12.jpg` },
    { title:"ふざけ合い", meta:"場所・日付 M", text:"笑顔が止まらなかった。", img:`${basePath}/photo13.jpg` },
    { title:"伝えたありがとう", meta:"場所・日付 N", text:"感謝の気持ち。", img:`${basePath}/photo14.jpg` },
    { title:"静かな朝", meta:"場所・日付 O", text:"穏やかな朝のコーヒー。", img:`${basePath}/photo15.jpg` },
    { title:"音楽を聴いた", meta:"場所・日付 P", text:"二人のプレイリスト。", img:`${basePath}/photo16.jpg` },
    { title:"手作りの贈り物", meta:"場所・日付 Q", text:"心を込めた贈り物。", img:`${basePath}/photo17.jpg` },
    { title:"夜景の下で", meta:"場所・日付 R", text:"灯りのきれいな場所。", img:`${basePath}/photo18.jpg` },
    { title:"未来の話", meta:"場所・日付 S", text:"これからのこと。", img:`${basePath}/photo19.jpg` },
    { title:"料理してもらった日", meta:"場所・日付 T", text:"幸せになった料理。", img:`${basePath}/photo20.jpg` },
    { title:"雨のカフェ", meta:"場所・日付 U", text:"雨音と過ごしたカフェ。", img:`${basePath}/photo21.jpg` },
    { title:"手紙をくれた", meta:"場所・日付 V", text:"心温まる手紙。", img:`${basePath}/photo22.jpg` },
    { title:"一緒に作った夢", meta:"場所・日付 W", text:"語り合った夢。", img:`${basePath}/photo23.jpg` },
    { title:"休日ののんびり", meta:"場所・日付 X", text:"何もしない贅沢。", img:`${basePath}/photo24.jpg` },
    { title:"空を見上げた", meta:"場所・日付 Y", text:"星空や雲を眺めた。", img:`${basePath}/photo25.jpg` },
    { title:"これからもよろしく！", meta:"場所・日付 Z", text:"26歳の誕生日おめでとう。", img:`${basePath}/photo26.jpg` }
  ];
